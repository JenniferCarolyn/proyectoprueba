view: fct_compras_comercios_td {
  sql_table_name: `bm-gcp-d1-dw.sigma_raw.fct_compras_comercios_td`
    ;;
  ...
  dimension: importe_retiro_efectivo {
    type: number
    sql: ${TABLE}.importe_retiro_efectivo ;;
  }
